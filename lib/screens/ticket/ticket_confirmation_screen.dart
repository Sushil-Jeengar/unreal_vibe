...
class TicketConfirmationScreen extends StatefulWidget {
  ...
  final String? bookingId; // New field from create order API
...
class _TicketConfirmationScreenState extends State<TicketConfirmationScreen> {
  ...
  CouponBooking? _appliedCouponData; // Real coupon data from API
  ...
  // Use API response data if coupon is applied, otherwise use original calculation
  double get _total => _appliedCouponData?.finalAmount ?? _subtotal;
  ...
  void _applyPromoCode() async {
    ...
    if (widget.bookingId == null) {
      _showErrorMessage('Booking ID not available. Please try again.');
      return;
    }
    ...
    try {
      ...
      if (couponResponse.success && couponResponse.booking != null) {
        setState(() {
          _appliedCouponData = couponResponse.booking;
          _isApplyingPromo = false;
        });
        
        final appliedCoupon = couponResponse.booking!.appliedCoupon;
        _showSuccessMessage(
          'Coupon "${appliedCoupon.code}" applied! ${appliedCoupon.displayValue} discount'
        );
      } else {
        setState(() {
          _isApplyingPromo = false;
        });
        _showErrorMessage(couponResponse.message.isNotEmpty 
      ...
      String errorMessage = 'Failed to apply coupon. Please try again.';
      
      if (e.toString().contains('INVALID_COUPON:')) {
        errorMessage = e.toString().replaceFirst('Exception: INVALID_COUPON: ', '');
      } else if (e.toString().contains('COUPON_LIMIT:')) {
        errorMessage = e.toString().replaceFirst('Exception: COUPON_LIMIT: ', '');
      } else if (e.toString().contains('AUTHENTICATION_REQUIRED')) {
        errorMessage = 'Please log in again to apply coupons.';
      } else if (e.toString().contains('SERVER_ERROR')) {
        errorMessage = 'Coupon service is temporarily unavailable.';
      }
      
      _showErrorMessage(errorMessage);
      print('Coupon application error: $e'); // Log detailed error
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          if (_appliedCouponData != null) ...[
            // Applied coupon display with real API data
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          _appliedCouponData!.appliedCoupon.code,
                          style: const TextStyle(
                            color: Color(0xFF10B981),
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                        ...
                        Text(
                          '${_appliedCouponData!.appliedCoupon.displayValue} discount applied',
                          style: const TextStyle(
                            color: Color(0xFF10B981),
                            fontSize: 14,
                          ),
                        ...
                        Text(
                          'You saved ₹${_appliedCouponData!.discountAmount.toInt()}',
                          style: const TextStyle(
                            color: Color(0xFF10B981),
                            fontSize: 12,
            ...
            // Show booking ID requirement if not available
            if (widget.bookingId == null) ...[
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Booking ID required to apply coupons',
                        style: TextStyle(
                          color: Colors.orange,
                          fontSize: 12,
                        ),
                ...
                children: [
                  ...
                  if (widget.bookingId != null) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        'Booking: ${widget.bookingId!.substring(0, 12)}...',
                        style: const TextStyle(
  ...
  Widget _buildPriceSummary() {
    return Container(
      ...
      child: Column(
        children: [
          // Show original amount if coupon is applied, otherwise show subtotal
          if (_appliedCouponData != null) ...[
            _buildPriceRow('Original Amount', _appliedCouponData!.originalAmount),
            const SizedBox(height: 12),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Row(
                  children: [
                    Text(
                      'Discount (${_appliedCouponData!.appliedCoupon.code})',
                      style: const TextStyle(
                        color: Color(0xFF10B981),
                        fontSize: 15,
                      ),
                    ...
                    const SizedBox(width: 4),
                    Text(
                      _appliedCouponData!.appliedCoupon.displayValue,
                      style: const TextStyle(
                        color: Color(0xFF10B981),
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
                ...
                Text(
                  '-₹${_appliedCouponData!.discountAmount.toInt()}',
                  style: const TextStyle(
                    color: Color(0xFF10B981),
                    fontSize: 15,
                    fontWeight: FontWeight.w600,
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  if (_appliedCouponData != null) ...[
                    // Show original total with strikethrough when coupon applied
                    Text(
                      '₹${_appliedCouponData!.originalAmount.toInt()}',
                      style: const TextStyle(
                        color: Color(0xFF6B7280),
                        fontSize: 16,
